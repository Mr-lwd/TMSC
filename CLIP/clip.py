...
_MODEL_CKPT_PATHS = {
    ...
    'ViT-B-16': Path(__file__).parent / "ckpt/ViT-B-16.pt",
    'ViT-B-32': Path(__file__).parent / "ckpt/ViT-B-32.pt",
}
_OPENAI_URLS = {
    'ViT-L-14-336': 'https://openaipublic.blob.core.windows.net/clip/models/ViT-L-14-336px.pt',
    'ViT-B-16': 'https://openaipublic.blob.core.windows.net/clip/models/ViT-B-16.pt',
    'ViT-B-32': 'https://openaipublic.blob.core.windows.net/clip/models/ViT-B-32.pt',
}
...
def create_model(
    ...
    lookup_name = _MODEL_ALIASES.get(model_name, model_name)
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        if pretrained:
            checkpoint_path = _MODEL_CKPT_PATHS[lookup_name]
            if checkpoint_path:
